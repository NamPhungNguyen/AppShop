...
mixin _$UserResponse {
  List<User> get result => throw _privateConstructorUsedError;
...
class _$UserResponseImpl implements _UserResponse {
  const _$UserResponseImpl({required final List<User> result})
      : _result = result;

  final List<User> _result;
  @override
...
abstract class _UserResponse implements UserResponse {
  const factory _UserResponse({required final List<User> result}) =
      _$UserResponseImpl;
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, username: $username, password: $password, email: $email, fullName: $fullName, phoneNumber: $phoneNumber, profileImgUrl: $profileImgUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
