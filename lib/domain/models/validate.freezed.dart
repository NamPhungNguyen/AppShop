...
mixin _$Validate {
  ...
  /// Create a copy of Validate
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ValidateCopyWith<Validate> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ValidateCopyWith<$Res> {
  factory $ValidateCopyWith(Validate value, $Res Function(Validate) then) =
      _$ValidateCopyWithImpl<$Res, Validate>;
  @useResult
  $Res call({int code, String message});
}

/// @nodoc
class _$ValidateCopyWithImpl<$Res, $Val extends Validate>
    implements $ValidateCopyWith<$Res> {
  _$ValidateCopyWithImpl(this._value, this._then);
...
class __$$ValidateImplCopyWithImpl<$Res>
    extends _$ValidateCopyWithImpl<$Res, _$ValidateImpl>
...
class _$ValidateImpl implements _Validate {
  const _$ValidateImpl({required this.code, required this.message});
  ...
  @override
  String toString() {
    return 'Validate(code: $code, message: $message)';
  }
...
abstract class _Validate implements Validate {
  const factory _Validate(
      {required final int code,
      required final String message}) = _$ValidateImpl;
