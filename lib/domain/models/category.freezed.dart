...
abstract class $CategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({int categoryId, String name, String description, String image});
}
...
class _$CategoryImpl implements _Category {
  ...
  @override
  String toString() {
    return 'Category(categoryId: $categoryId, name: $name, description: $description, image: $image)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, categoryId, name, description, image);
...
class _$CategoriesImpl implements _Categories {
  const _$CategoriesImpl({required final List<Category> result})
      : _result = result;
  ...
  @override
  String toString() {
    return 'Categories(result: $result)';
  }
...
abstract class _Categories implements Categories {
  const factory _Categories({required final List<Category> result}) =
      _$CategoriesImpl;
