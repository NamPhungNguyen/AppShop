...
class _$SignUpImpl implements _SignUp {
  const _$SignUpImpl({required this.code, required this.message});
  ...
  @override
  String toString() {
    return 'SignUp(code: $code, message: $message)';
  }
...
abstract class _SignUp implements SignUp {
  const factory _SignUp(
      {required final int code, required final String message}) = _$SignUpImpl;
