...
mixin _$CartProducts {
  List<CartProduct> get result => throw _privateConstructorUsedError;
...
abstract class $CartProductsCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CartProduct> result});
}
...
class _$CartProductsImpl implements _CartProducts {
  const _$CartProductsImpl({required final List<CartProduct> result})
      : _result = result;

  final List<CartProduct> _result;
  @override
  List<CartProduct> get result {
  ...
  @override
  String toString() {
    return 'CartProducts(result: $result)';
  }
...
abstract class _CartProducts implements CartProducts {
  const factory _CartProducts({required final List<CartProduct> result}) =
      _$CartProductsImpl;
